...
# função saudacao para dar boas vindas dependendo do horário
...
def again():
    ...
    if calcular_denovo.upper().strip()[0] == "S" or calcular_denovo.upper() == 'SIM':
        os.system('cls')    # Usado no import
        calculadora()
    elif calcular_denovo.upper().strip()[0] == "N" or calcular_denovo.upper() == 'NÃO':
...
def saudacao(): # Função de saudação 
